...
/**
 *  Operations for service "myappdb"
 *  12/02/2014 14:50:38
 * 
 */
    ...
    implements DataServiceManagerAccess, LiveDataService
{
    ...
    public com.myappdb.data.Roles getRolesById(String id, PagingOptions pagingOptions) {
        List<com.myappdb.data.Roles> rtn = ((List<com.myappdb.data.Roles> ) dsMgr.invoke(taskMgr.getQueryTask(), (MyappdbConstants.getRolesByIdQueryName), id, pagingOptions));
        if (rtn.isEmpty()) {
            return null;
        } else {
            return rtn.get(0);
