...
(function(){
	...
	dojo.declare("dojox.grid.cells._Widget", dgc._Base, {
		...
		return this.widgetProps && this.widgetProps.regExp ? dijit.form.ValidationTextBox : dijit.form.TextBox;
	    },
		...
		createWidget: function(inNode, inDatum, inRowIndex){
		    var ctor = this.getWidgetClass();
		    return new ctor(this.getWidgetProps(inDatum), inNode);
		},
