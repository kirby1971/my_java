...
if(!_82.children){
_84=new dijit.MenuItem({label:"<img src=\"../wavemaker/lib/dojo/dojo/resources/blank.gif\" alt=\"\" class=\"dijitIcon dijitMenuItemIcon app_silkIconList_6\" dojoattachpoint=\"iconNode\">"+_82.label,iconClass:_82.iconClass});
}else{
...
var _8d=[];
if(_8a.onClick){
_8d.push(_8a.onClick);
delete _8a.onClick;
for(var i=1;i<20;i++){
if(_8a["onClick"+i]){
_8d.push(_8a["onClick"+i]);
delete _8a["onClick"+i];
}
}
}
...
var _8f=_8a.iconClass?"<img src=\"../wavemaker/lib/dojo/dojo/resources/blank.gif\" alt=\"\" class=\"dijitIcon dijitMenuBarItemIcon dijitMenuItemIcon "+_8a.iconClass+"\" dojoattachpoint=\"iconNode\">":"";
if(this.vertical){
_8c=new dijit.MenuItem({label:_8f+_8a.label,data:_8a});
}else{
_8c=new dijit.PopupMenuBarItem({label:_8f+_8a.label,data:_8a});
}
}else{
...
if(dojo.isString(c)){
var f=this.owner[c];
this._menuConnects.push(dojo.connect(_8c,"onClick",this.owner.makeEvent(f||c,c,this,"onClick")));
}else{
this._menuConnects.push(dojo.connect(_8c,"onClick",dojo.hitch(this.owner,c,_8c,_8a)));
}
}
...
this.blockRightClickOnMenu(_90.domNode);
dojo.addClass(_90.domNode,this.owner.name+"_"+this.name+"_PopupMenu");
dojo.addClass(_90.domNode,this.owner.name+"_"+_8e+"_PopupMenu");
for(var i=0;i<_8a.children.length;i++){
var _91=_8a.children[i];
this.addAdvancedMenuChildren(_90,_91,false);
}
_8c.popup=_90;
var _92=dojo.query(".dijitMenuArrowCell div",_8c.domNode)[0];
if(_92){
...
return _8c;
},onclick:function(_93,_94,_95){
},addNewMenuItem:function(_96,_97){
if(!_96.popup){
var _98=new dijit.Menu({});
dojo.addClass(_98.domNode,this.owner.name+"_"+this.name+"_PopupMenu");
if(_97.idInPage){
dojo.addClass(_98.domNode,this.owner.name+"_"+_97.idInPage+"_PopupMenu");
}
_96.popup=_98;
}
this.addAdvancedMenuChildren(_96.popup,_97,false);
},dojoRenderer:function(){
},setFullStructureStr:function(_99,_9a){
this.fullStructureStr=_99;
this.setFullStructure(dojo.fromJson(_99));
if(_9a){
this.renderDojoObj();
}
},setFullStructure:function(_9b){
this.fullStructure=_9b;
this.fullStructureStr="";
this.eventList=[];
},getStructure:function(){
return this.structure==""?{items:[]}:dojo.fromJson(this.structure);
},setStructure:function(_9c){
if(this.fullStructure&&this.fullStructure.length>0){
return;
}
if(_9c==""){
...
var _a1=_a0[i].split(">");
var obj={label:dojo.trim(_a1[0])};
var _a2=this.findInItems(_9e,obj.label);
if(_a2==null){
_9d[_9d.length]=obj;
}
...
var _a5={label:dojo.trim(_a4[j])};
this.addToEventList(dojo.clone(_a5));
_a3[_a3.length]=_a5;
_9e[_9e.length]=_a5;
_9d[_9d.length]=dojo.clone(_a5);
}
obj.children=_a3;
}
if(_a2!=null){
...
this.removeOldEvents(_9d);
this.structure=dojo.toJson({items:_9f});
},findInItems:function(_a6,_a7){
...
},removeOldEvents:function(_a8){
var _a9=[];
for(var i=0;i<this.eventList.length;i++){
var _aa=this.eventList[i];
var _ab=false;
for(var j=0;j<_a8.length;j++){
if(_aa.label==_a8[j].label){
_a9[_a9.length]=_aa;
}
}
}
this.eventList=_a9;
},overrideCSS:function(_ac,_ad){
dojox.html.insertCssRule(this.getCSSMenuTypeClass(_ac)+this.id+"_CSS",_ad);
},getCSSMenuTypeClass:function(_ae){
switch(_ae){
case "MenuBar":
...
},setMenu:function(_af){
this.menu=_af;
this.setStructure(_af);
this.renderDojoObj();
},setItemDisabled:function(_b0,_b1){
if(this._dijitHash[_b0]){
this._dijitHash[_b0].set("disabled",_b1);
}
},setItemShowing:function(_b2,_b3){
if(this._dijitHash[_b2]){
this._dijitHash[_b2].domNode.style.display=_b3?"":"none";
}
},getItemChecked:function(_b4){
if(this._dijitHash[_b4]){
return this._dijitHash[_b4].get("checked");
}
return false;
},setItemChecked:function(_b5,_b6){
if(this._dijitHash[_b5]){
this._dijitHash[_b5].set("checked",Boolean(_b6));
}
}});
...
},activate:function(_b7){
if(this.isDesignLoaded()){
this.dojoObj._scheduleOpen(studio.designer.domNode);
}else{
if(_b7){
this.setShowing(true,_b7);
}
}
},update:function(_b8,_b9,_ba){
this.target=_b9;
if(_ba||!_b8){
var _bb=dojo.coords(_b9.domNode);
var _bc=_b9.getContentBounds();
var y=_bb.y+_bc.h;
var x=_bb.x;
this.dojoObj.domNode.style.width=(_bc.w+_b9.borderExtents.l+_b9.borderExtents.r)+"px";
this.dojoObj.domNode.style.borderTop="solid 1px "+_b9.borderColor;
this.dojoObj._scheduleOpen(_b9.domNode,null,{x:x,y:y});
}else{
this.dojoObj._scheduleOpen(_b8.target,null,{x:_b8.pageX,y:_b8.pageY});
}
},setShowing:function(_bd,_be){
if(_bd){
this.dojoObj._scheduleOpen(_be);
}
},setLabel:function(_bf,_c0){
this.dojoObj.getChildren()[_bf].set("label",_c0);
},removeAllChildren:function(){
var _c1=this.dojoObj.getChildren();
for(var i=_c1.length-1;i>=0;i--){
_c1[i].destroy();
}
...
},onchange:function(_c2,_c3,_c4){
},onchangeNoInit:function(_c5,_c6,_c7){
},postInit:function(){
...
this.inherited(arguments);
},menuChange:function(_c8,_c9,_ca){
this.setProp("caption",_c8);
this.iconClass=_c9;
if(_c9){
var img=dojo.query(".dijitIcon."+_c9)[0];
if(img){
var _cb=dojo.getComputedStyle(img);
var _cc=_cb.width;
var _cd=_cb.height;
this.iconWidth=_cc;
this.iconHeight=_cd;
...
this.render(true);
this.onchange(_c8,_c9,_ca);
this.onchangeNoInit(_c8,_c9,_ca);
...
var _cf=dojo.coords(dojo.query(".popupIcon",this.domNode)[0]);
var _d0=_cf.x-2;
if(_ce.clientX>=_d0){
this.dojoMenu.update(_ce,this,true);
}else{
this.onclick(_ce,this);
if(!this.clicked){
...
},setIconClass:function(_d2){
this.iconClass=_d2;
if(this.isReflowEnabled()){
this.render(true);
}
},setFullStructureStr:function(_d3,_d4){
this.fullStructureStr=_d3;
this.dojoMenu.setFullStructureStr(_d3);
this.dojoMenu.renderDojoObj();
if(!this.caption){
this.set_caption();
}
if(_d4&&this.isDesignLoaded()){
studio.inspector.reinspect();
}
},setFullStructure:function(_d5){
this.dojoMenu.setFullStructure(_d5);
this.dojoMenu.renderDojoObj();
},setCaption:function(_d6){
this.inherited(arguments);
this.valueChanged("caption",_d6);
},_end:0});
}
