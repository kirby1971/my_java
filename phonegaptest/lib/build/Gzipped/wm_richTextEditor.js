...
if(this._jsonData){
throw new Error("dojo.data.ItemFileReadStore:  The json data provided by the creation arguments is malformed.  Items within the list have identifier: ["+_1bf+"].  Value collided/not unique: ["+_1c0+"]");
}
}
}
}
...
dojo.colorFromRgb=function(_1fc,obj){
var m=_1fc.toLowerCase().match(/^(rgba?|hsla?)\(([\s\.\-,%0-9]+)\)/);
if(m){
...
a=[_1fb(m1,m2,H+1/3)*256,_1fb(m1,m2,H)*256,_1fb(m1,m2,H-1/3)*256,1];
if(l==4){
a[3]=c[3];
}
return dojo.colorFromArray(a,obj);
...
var _1fd=function(c,low,high){
c=Number(c);
return isNaN(c)?high:c<low?low:c>high?high:c;
};
dojo.Color.prototype.sanitize=function(){
var t=this;
t.r=Math.round(_1fd(t.r,0,255));
t.g=Math.round(_1fd(t.g,0,255));
t.b=Math.round(_1fd(t.b,0,255));
t.a=_1fd(t.a,0,1);
return this;
};
})();
...
dojo.declare("dijit._PaletteMixin",[dijit._CssStateMixin],{defaultTimeout:500,timeoutChangeRate:0.9,value:null,_selectedCell:-1,tabIndex:"0",cellClass:"dijitPaletteCell",dyeClass:"",_preparePalette:function(_1fe,_1ff,_200){
this._cells=[];
var url=this._blankGif;
_200=_200||dojo.getObject(this.dyeClass);
for(var row=0;row<_1fe.length;row++){
var _201=dojo.create("tr",{tabIndex:"-1"},this.gridNode);
for(var col=0;col<_1fe[row].length;col++){
var _202=_1fe[row][col];
if(_202){
var _203=new _200(_202,row,col);
var _204=dojo.create("td",{"class":this.cellClass,tabIndex:"-1",title:_1ff[_202]});
_203.fillCell(_204,url);
this.connect(_204,"ondijitclick","_onCellClick");
this._trackMouseState(_204,this.cellClass);
dojo.place(_204,_201);
_204.index=this._cells.length;
this._cells.push({node:_204,dye:_203});
}
}
}
this._xDim=_1fe[0].length;
this._yDim=_1fe.length;
var _205={UP_ARROW:-this._xDim,DOWN_ARROW:this._xDim,RIGHT_ARROW:this.isLeftToRight()?1:-1,LEFT_ARROW:this.isLeftToRight()?-1:1};
for(var key in _205){
...
var _208=evt.currentTarget,_209=this._getDye(_208).getValue();
this._setCurrent(_208);
setTimeout(dojo.hitch(this,function(){
dijit.focus(_208);
this._setValueAttr(_209,true);
}));
dojo.removeClass(_208,"dijitPaletteCellHover");
dojo.stopEvent(evt);
...
if(_20a==this._cells[i].dye.getValue()){
...
this._set("value",this._selectedCell>=0?_20a:null);
if(_20b||_20b===undefined){
this.onChange(_20a);
}
},onChange:function(_20c){
},_navigateByKey:function(_20d,_20e){
if(_20e==-1){
return;
}
var _20f=this._currentFocus.index+_20d;
if(_20f<this._cells.length&&_20f>-1){
var _210=this._cells[_20f].node;
this._setCurrent(_210);
setTimeout(dojo.hitch(dijit,"focus",_210),0);
}
...
dojo.declare("dijit._Color",dojo.Color,{template:"<span class='dijitInline dijitPaletteImg'>"+"<img src='${blankGif}' alt='${alt}' class='dijitColorPaletteSwatch' style='background-color: ${color}'/>"+"</span>",hcTemplate:"<span class='dijitInline dijitPaletteImg' style='position: relative; overflow: hidden; height: 12px; width: 14px;'>"+"<img src='${image}' alt='${alt}' style='position: absolute; left: ${left}px; top: ${top}px; ${size}'/>"+"</span>",_imagePaths:{"7x10":dojo.moduleUrl("dijit.themes","a11y/colors7x10.png"),"3x4":dojo.moduleUrl("dijit.themes","a11y/colors3x4.png")},constructor:function(_211,row,col){
this._alias=_211;
this._row=row;
this._col=col;
this.setColor(dojo.Color.named[_211]);
},getValue:function(){
return this.toHex();
},fillCell:function(cell,_212){
var html=dojo.string.substitute(this.hc?this.hcTemplate:this.template,{color:this.toHex(),blankGif:_212,alt:this._alias,image:this._imagePaths[this.palette].toString(),left:this._col*-20-5,top:this._row*-20-5,size:this.palette=="7x10"?"height: 145px; width: 206px":"height: 64px; width: 86px"});
...
this.connect(this.dropDown,"onChange",function(_213){
this.editor.execCommand(this.command,_213);
});
},updateState:function(){
var _214=this.editor;
var _215=this.command;
if(!_214||!_214.isLoaded||!_215.length){
return;
}
if(this.button){
var _216=this.get("disabled");
this.button.set("disabled",_216);
if(_216){
return;
}
var _217;
try{
_217=_214.queryCommandValue(_215)||"";
}
catch(e){
_217="";
}
...
if(_217.indexOf("rgb")>-1){
_217=dojo.colorFromRgb(_217).toHex();
}
}else{
_217=((_217&255)<<16)|(_217&65280)|((_217&16711680)>>>16);
_217=_217.toString(16);
_217="#000000".slice(0,7-_217.length)+_217;
}
if(_217!==this.dropDown.get("value")){
this.dropDown.set("value",_217,false);
}
}});
dojo.subscribe(dijit._scopeName+".Editor.getPlugin",null,function(o){
if(o.plugin){
...
var _219=dijit._Contained.prototype.getParent.call(this);
this._childOfLayoutWidget=_219&&_219.isLayoutContainer;
...
var _21a=dojo.query("> *",this.containerNode).filter(function(node){
return node.tagName!=="SCRIPT";
}),_21b=_21a.filter(function(node){
return dojo.hasAttr(node,"data-dojo-type")||dojo.hasAttr(node,"dojoType")||dojo.hasAttr(node,"widgetId");
}),_21c=dojo.filter(_21b.map(dijit.byNode),function(_21d){
return _21d&&_21d.domNode&&_21d.resize;
});
if(_21a.length==_21b.length&&_21c.length==1){
this._singleChild=_21c[0];
}else{
delete this._singleChild;
}
dojo.toggleClass(this.containerNode,this.baseClass+"SingleChild",!!this._singleChild);
},resize:function(_21e,_21f){
if(!this._wasShown&&this.open!==false){
this._onShow();
}
this._resizeCalled=true;
this._scheduleLayout(_21e,_21f);
},_scheduleLayout:function(_220,_221){
if(this._isShown()){
this._layout(_220,_221);
}else{
this._needLayout=true;
this._changeSize=_220;
this._resultSize=_221;
}
},_layout:function(_222,_223){
if(_222){
...
var node=this.domNode,_225=this.domNode.parentNode;
return (node.style.display!="none")&&(node.style.visibility!="hidden")&&!dojo.hasClass(node,"dijitHidden")&&_225&&_225.style&&(_225.style.display!="none");
}
}
},_onShow:function(){
if(this._needLayout){
...
for(var _227=cont.length,i=0;i<cont.length;i=_227==cont.length?i+1:0){
...
dojo.declare("dojo.html._ContentSetter",null,{node:"",content:"",id:"",cleanContent:false,extractContent:false,parseContent:false,parserScope:dojo._scopeName,startup:true,constructor:function(_228,node){
dojo.mixin(this,_228||{});
node=this.node=dojo.byId(this.node||node);
if(!this.id){
this.id=["Setter",(node)?node.id||node.tagName:"",_226++].join("_");
}
},set:function(cont,_229){
if(undefined!==cont){
this.content=cont;
}
if(_229){
...
var _22b=cont.match(/<body[^>]*>\s*([\s\S]+)\s*<\/body>/im);
if(_22b){
cont=_22b[1];
}
}
...
this.parseResults=dojo.parser.parse({rootNode:_22e,noStart:!this.startup,inherited:_22f,scope:this.parserScope});
}
catch(e){
this._onError("Content",e,"Error parsing in _ContentSetter#"+this.id);
}
},_onError:function(type,err,_230){
var _231=this["on"+type+"Error"].call(this,err);
if(_230){
console.error(_230,err);
}else{
if(_231){
dojo.html._setNodeContent(this.node,_231,true);
}
}
}});
dojo.html.set=function(node,cont,_232){
if(undefined==cont){
...
var op=new dojo.html._ContentSetter(dojo.mixin(_232,{content:cont,node:node}));
return op.set();
}
};
})();
...
dojo.declare("dijit.layout.ContentPane",[dijit._Widget,dijit.layout._ContentPaneResizeMixin],{href:"",extractContent:false,parseOnLoad:true,parserScope:dojo._scopeName,preventCache:false,preload:false,refreshOnShow:false,loadingMessage:"<span class='dijitContentPaneLoading'>${loadingState}</span>",errorMessage:"<span class='dijitContentPaneError'>${errorState}</span>",isLoaded:false,baseClass:"dijitContentPane",ioArgs:{},onLoadDeferred:null,attributeMap:dojo.delegate(dijit._Widget.prototype.attributeMap,{title:[]}),stopParser:true,template:false,create:function(_233,_234){
if((!_233||!_233.template)&&_234&&!("href" in _233)&&!("content" in _233)){
var df=dojo.doc.createDocumentFragment();
_234=dojo.byId(_234);
while(_234.firstChild){
df.appendChild(_234.firstChild);
}
_233=dojo.delegate(_233,{content:df});
}
this.inherited(arguments,[_233,_234]);
},postMixInProperties:function(){
this.inherited(arguments);
var _235=dojo.i18n.getLocalization("dijit","loading",this.lang);
this.loadingMessage=dojo.string.substitute(this.loadingMessage,_235);
this.errorMessage=dojo.string.substitute(this.errorMessage,_235);
...
this.inherited(arguments);
},destroyRecursive:function(_236){
if(this._beingDestroyed){
return;
}
this.inherited(arguments);
...
var self=this;
var _237={preventCache:(this.preventCache||this.refreshOnShow),url:this.href,handleAs:"text"};
if(dojo.isObject(this.ioArgs)){
dojo.mixin(_237,this.ioArgs);
}
var hand=(this._xhrDfd=(this.ioMethod||dojo.xhrGet)(_237));
...
var _238=this._contentSetter;
dojo.forEach(this.getChildren(),function(_239){
if(_239.destroyRecursive){
_239.destroyRecursive();
}
});
if(_238){
dojo.forEach(_238.parseResults,function(_23a){
if(_23a.destroyRecursive&&_23a.domNode&&_23a.domNode.parentNode==dojo.body()){
_23a.destroyRecursive();
}
});
delete _238.parseResults;
}
dojo.html._emptyNode(this.containerNode);
delete this._singleChild;
},_setContent:function(cont,_23b){
this.destroyDescendants();
var _23c=this._contentSetter;
if(!(_23c&&_23c instanceof dojo.html._ContentSetter)){
_23c=this._contentSetter=new dojo.html._ContentSetter({node:this.containerNode,_onError:dojo.hitch(this,this._onError),onContentError:dojo.hitch(this,function(e){
var _23d=this.onContentError(e);
try{
this.containerNode.innerHTML=_23d;
}
catch(e){
...
var _23e=dojo.mixin({cleanContent:this.cleanContent,extractContent:this.extractContent,parseContent:this.parseOnLoad,parserScope:this.parserScope,startup:false,dir:this.dir,lang:this.lang},this._contentSetterParams||{});
_23c.set((dojo.isObject(cont)&&cont.domNode)?cont.domNode:cont,_23e);
...
},onContentError:function(_241){
},onDownloadError:function(_242){
...
dojo.forEach(this.getDescendants(),function(_243){
if(_243.reset){
_243.reset();
}
});
...
var _244=false;
return dojo.every(dojo.map(this.getDescendants(),function(_245){
_245._hasBeenBlurred=true;
var _246=_245.disabled||!_245.validate||_245.validate();
if(!_246&&!_244){
dojo.window.scrollIntoView(_245.containerNode||_245.domNode);
_245.focus();
_244=true;
}
return _246;
...
var map={};
dojo.forEach(this.getDescendants(),function(_247){
if(!_247.name){
return;
}
var _248=map[_247.name]||(map[_247.name]=[]);
_248.push(_247);
});
for(var name in map){
...
var _249=map[name],_24a=dojo.getObject(name,false,obj);
if(_24a===undefined){
continue;
}
if(!dojo.isArray(_24a)){
_24a=[_24a];
}
if(typeof _249[0].checked=="boolean"){
dojo.forEach(_249,function(w,i){
w.set("value",dojo.indexOf(_24a,w.value)!=-1);
});
}else{
if(_249[0].multiple){
_249[0].set("value",_24a);
}else{
dojo.forEach(_249,function(w,i){
w.set("value",_24a[i]);
});
...
var obj={};
dojo.forEach(this.getDescendants(),function(_24b){
var name=_24b.name;
if(!name||_24b.disabled){
return;
}
var _24c=_24b.get("value");
if(typeof _24b.checked=="boolean"){
if(/Radio/.test(_24b.declaredClass)){
if(_24c!==false){
dojo.setObject(name,_24c,obj);
}else{
_24c=dojo.getObject(name,false,obj);
if(_24c===undefined){
...
dojo.setObject(name,[prev,_24c],obj);
}
}else{
dojo.setObject(name,_24c,obj);
}
...
return this.state=="";
},onValidStateChange:function(_24d){
},_getState:function(){
var _24e=dojo.map(this._descendants,function(w){
return w.get("state")||"";
});
return dojo.indexOf(_24e,"Error")>=0?"Error":dojo.indexOf(_24e,"Incomplete")>=0?"Incomplete":"";
},disconnectChildren:function(){
dojo.forEach(this._childConnections||[],dojo.hitch(this,"disconnect"));
dojo.forEach(this._childWatches||[],function(w){
w.unwatch();
});
},connectChildren:function(_24f){
var _250=this;
this.disconnectChildren();
this._descendants=this.getDescendants();
var set=_24f?function(name,val){
_250[name]=val;
}:dojo.hitch(this,"_set");
set("value",this.get("value"));
set("state",this._getState());
var _251=(this._childConnections=[]),_252=(this._childWatches=[]);
dojo.forEach(dojo.filter(this._descendants,function(item){
return item.validate;
}),function(_253){
dojo.forEach(["state","disabled"],function(attr){
_252.push(_253.watch(attr,function(attr,_254,_255){
_250.set("state",_250._getState());
}));
});
});
var _256=function(){
if(_250._onChangeDelayTimer){
clearTimeout(_250._onChangeDelayTimer);
}
_250._onChangeDelayTimer=setTimeout(function(){
delete _250._onChangeDelayTimer;
_250._set("value",_250.get("value"));
},10);
};
dojo.forEach(dojo.filter(this._descendants,function(item){
return item.onChange;
}),function(_257){
_251.push(_250.connect(_257,"onChange",_256));
_252.push(_257.watch("disabled",_256));
});
},startup:function(){
this.inherited(arguments);
this.connectChildren(true);
this.watch("state",function(attr,_258,_259){
this.onValidStateChange(_259=="");
});
},destroy:function(){
this.disconnectChildren();
this.inherited(arguments);
...
dojo.declare("dijit._DialogMixin",null,{attributeMap:dijit._Widget.prototype.attributeMap,execute:function(_25a){
},onCancel:function(){
},onExecute:function(){
},_onSubmit:function(){
this.onExecute();
...
var _25b=dijit._getTabNavigable(this.containerNode);
...
dojo.declare("dijit.TooltipDialog",[dijit.layout.ContentPane,dijit._Templated,dijit.form._FormMixin,dijit._DialogMixin],{title:"",doLayout:false,autofocus:true,baseClass:"dijitTooltipDialog",_firstFocusItem:null,_lastFocusItem:null,templateString:dojo.cache("dijit","templates/TooltipDialog.html","<div role=\"presentation\" tabIndex=\"-1\">\r\n\t<div class=\"dijitTooltipContainer\" role=\"presentation\">\r\n\t\t<div class =\"dijitTooltipContents dijitTooltipFocusNode\" dojoAttachPoint=\"containerNode\" role=\"dialog\"></div>\r\n\t</div>\r\n\t<div class=\"dijitTooltipConnector\" role=\"presentation\"></div>\r\n</div>\r\n"),_setTitleAttr:function(_25c){
this.containerNode.title=_25c;
this._set("title",_25c);
},postCreate:function(){
this.inherited(arguments);
this.connect(this.containerNode,"onkeypress","_onKey");
},orient:function(node,_25d,_25e){
var newC="dijitTooltipAB"+(_25e.charAt(1)=="L"?"Left":"Right")+" dijitTooltip"+(_25e.charAt(0)=="T"?"Below":"Above");
...
var _25f=(this._firstFocusItem==this._lastFocusItem);
...
dojo.declare("dijit.form._FormSelectWidget",dijit.form._FormValueWidget,{multiple:false,options:null,store:null,query:null,queryOptions:null,onFetch:null,sortByLabel:true,loadChildrenOnOpen:false,getOptions:function(_260){
var _261=_260,opts=this.options||[],l=opts.length;
if(_261===undefined){
return opts;
}
if(dojo.isArray(_261)){
return dojo.map(_261,"return this.getOptions(item);",this);
}
if(dojo.isObject(_260)){
if(!dojo.some(this.options,function(o,idx){
if(o===_261||(o.value&&o.value===_261.value)){
_261=idx;
return true;
}
return false;
...
for(var i=0;i<l;i++){
if(opts[i].value===_261){
_261=i;
break;
}
}
}
if(typeof _261=="number"&&_261>=0&&_261<l){
return this.options[_261];
}
return null;
},addOption:function(_262){
...
this._loadChildren();
},removeOption:function(_263){
if(!dojo.isArray(_263)){
_263=[_263];
}
var _264=this.getOptions(_263);
dojo.forEach(_264,function(i){
if(i){
...
this._loadChildren();
},updateOption:function(_265){
if(!dojo.isArray(_265)){
_265=[_265];
}
dojo.forEach(_265,function(i){
var _266=this.getOptions(i),k;
if(_266){
for(k in i){
_266[k]=i[k];
}
...
this._loadChildren();
},setStore:function(_267,_268,_269){
var _26a=this.store;
_269=_269||{};
if(_26a!==_267){
dojo.forEach(this._notifyConnections||[],dojo.disconnect);
delete this._notifyConnections;
if(_267&&_267.getFeatures()["dojo.data.api.Notification"]){
this._notifyConnections=[dojo.connect(_267,"onNew",this,"_onNewItem"),dojo.connect(_267,"onDelete",this,"_onDeleteItem"),dojo.connect(_267,"onSet",this,"_onSetItem")];
}
this._set("store",_267);
}
...
_267.fetch(dojo.delegate(_269,{onComplete:function(_26b,opts){
if(this.sortByLabel&&!_269.sort&&_26b.length){
_26b.sort(dojo.data.util.sorter.createSortFunction([{attribute:_267.getLabelAttributes(_26b[0])[0]}],_267));
}
if(_269.onFetch){
_26b=_269.onFetch.call(this,_26b,opts);
}
dojo.forEach(_26b,function(i){
this._addOptionForItem(i);
},this);
this._loadingStore=false;
this.set("value","_pendingValue" in this?this._pendingValue:_268);
delete this._pendingValue;
if(!this.loadChildrenOnOpen){
this._loadChildren();
}else{
this._pseudoLoadChildren(_26b);
}
...
return _26a;
},_setValueAttr:function(_26c,_26d){
if(this._loadingStore){
this._pendingValue=_26c;
return;
}
var opts=this.getOptions()||[];
if(!dojo.isArray(_26c)){
_26c=[_26c];
}
dojo.forEach(_26c,function(i,idx){
if(!dojo.isObject(i)){
i=i+"";
}
if(typeof i==="string"){
_26c[idx]=dojo.filter(opts,function(node){
return node.value===i;
})[0]||{value:"",label:""};
}
},this);
_26c=dojo.filter(_26c,function(i){
return i&&i.value;
});
if(!this.multiple&&(!_26c[0]||!_26c[0].value)&&opts.length){
_26c[0]=opts[0];
}
dojo.forEach(opts,function(i){
i.selected=dojo.some(_26c,function(v){
return v.value===i.value;
});
});
var val=dojo.map(_26c,function(i){
return i.value;
}),disp=dojo.map(_26c,function(i){
return i.label;
});
this._set("value",this.multiple?val:val[0]);
this._setDisplay(this.multiple?disp:disp[0]);
this._updateSelection();
this._handleOnChange(this.value,_26d);
...
dojo.forEach(this._getChildren(),function(_26e){
...
if(val&&val[0]){
dojo.forEach(this._getChildren(),function(_26f){
var _270=dojo.some(val,function(v){
return _26f.option&&(v===_26f.option.value);
});
dojo.toggleClass(_26f.domNode,this.baseClass+"SelectedOption",_270);
dijit.setWaiState(_26f.domNode,"selected",_270);
},this);
}
...
return "";
},_onNewItem:function(item,_271){
if(!_271||!_271.parent){
this._addOptionForItem(item);
}
},_onDeleteItem:function(item){
var _272=this.store;
this.removeOption(_272.getIdentity(item));
},_onSetItem:function(item){
this.updateOption(this._getOptionObjForItem(item));
},_getOptionObjForItem:function(item){
var _273=this.store,_274=_273.getLabel(item),_275=(_274?_273.getIdentity(item):null);
return {value:_275,label:_274,item:item};
},_addOptionForItem:function(item){
var _276=this.store;
if(!_276.isItemLoaded(item)){
_276.loadItem({item:item,onComplete:function(i){
this._addOptionForItem(item);
},scope:this});
return;
}
var _277=this._getOptionObjForItem(item);
this.addOption(_277);
},constructor:function(_278){
this._oValue=(_278||{}).value||null;
},buildRendering:function(){
this.inherited(arguments);
...
if(_279&&_279.getFeatures()["dojo.data.api.Identity"]){
this.store=null;
this.setStore(_279,this._oValue,_27a);
}
},destroy:function(){
dojo.forEach(this._notifyConnections||[],dojo.disconnect);
this.inherited(arguments);
},_addOptionItem:function(_27b){
},_removeOptionItem:function(_27c){
},_setDisplay:function(_27d){
},_getChildren:function(){
return [];
},_getSelectedOptionsAttr:function(){
return this.getOptions(this.get("value"));
},_pseudoLoadChildren:function(_27e){
},onSetStore:function(){
}});
}
...
this.inherited(arguments);
},_setSelected:function(_281){
dojo.toggleClass(this.domNode,"dijitMenuItemSelected",_281);
},setLabel:function(_282){
dojo.deprecated("dijit.MenuItem.setLabel() is deprecated.  Use set('label', ...) instead.","","2.0");
this.set("label",_282);
},setDisabled:function(_283){
dojo.deprecated("dijit.Menu.setDisabled() is deprecated.  Use set('disabled', bool) instead.","","2.0");
this.set("disabled",_283);
},_setDisabledAttr:function(_284){
dijit.setWaiState(this.focusNode,"disabled",_284?"true":"false");
this._set("disabled",_284);
},_setAccelKeyAttr:function(_285){
this.accelKeyNode.style.display=_285?"":"none";
this.accelKeyNode.innerHTML=_285;
dojo.attr(this.containerNode,"colSpan",_285?"1":"2");
this._set("accelKey",_285);
}});
}
...
dijit.PopupMenuItem.superclass._fillContent.call(this,_286[0]);
...
dojo.forEach(this.getChildren(),function(_289){
_289.startup();
});
this.startupKeyNavChildren();
this.inherited(arguments);
},onExecute:function(){
},onCancel:function(_28a){
},_moveToPopup:function(evt){
if(this.focusedChild&&this.focusedChild.popup&&!this.focusedChild.disabled){
this.focusedChild._onClick(evt);
}else{
var _28b=this._getTopMenu();
if(_28b&&_28b._isMenuBar){
_28b.focusNext();
}
}
},_onPopupHover:function(evt){
if(this.currentPopup&&this.currentPopup._pendingClose_timer){
var _28c=this.currentPopup.parentMenu;
if(_28c.focusedChild){
_28c.focusedChild._setSelected(false);
}
_28c.focusedChild=this.currentPopup.from_item;
_28c.focusedChild._setSelected(true);
...
var _28d=item.popup;
if(_28d){
this._stopPendingCloseTimer(_28d);
_28d._pendingClose_timer=setTimeout(function(){
_28d._pendingClose_timer=null;
if(_28d.parentMenu){
_28d.parentMenu.currentPopup=null;
}
dijit.popup.close(_28d);
},this.popupDelay);
}
...
},_stopPendingCloseTimer:function(_28e){
if(_28e._pendingClose_timer){
clearTimeout(_28e._pendingClose_timer);
_28e._pendingClose_timer=null;
}
...
this._stopPopupTimer();
var _28f=this.focusedChild;
if(!_28f){
return;
}
var _290=_28f.popup;
if(_290.isShowingNow){
return;
}
...
_290.parentMenu=this;
_290.from_item=_28f;
var self=this;
dijit.popup.open({parent:this,popup:_290,around:_28f.domNode,orient:this._orient||(this.isLeftToRight()?{"TR":"TL","TL":"TR","BR":"BL","BL":"BR"}:{"TL":"TR","TR":"TL","BL":"BR","BR":"BL"}),onCancel:function(){
self.focusChild(_28f);
self._cleanUp();
_28f._setSelected(true);
self.focusedChild=_28f;
},onExecute:dojo.hitch(this,"_cleanUp")});
this.currentPopup=_290;
_290.connect(_290.domNode,"onmouseenter",dojo.hitch(self,"_onPopupHover"));
if(_290.focus){
_290._focus_timer=setTimeout(dojo.hitch(_290,function(){
this._focus_timer=null;
this.focus();
}),0);
}
...
this._stopPopupTimer();
var _291=this.focusedChild&&this.focusedChild.from_item;
if(this.currentPopup){
...
},_iframeContentWindow:function(_292){
var win=dojo.window.get(this._iframeContentDocument(_292))||this._iframeContentDocument(_292)["__parent__"]||(_292.name&&dojo.doc.frames[_292.name])||null;
return win;
},_iframeContentDocument:function(_293){
var doc=_293.contentDocument||(_293.contentWindow&&_293.contentWindow.document)||(_293.name&&dojo.doc.frames[_293.name]&&dojo.doc.frames[_293.name].document)||null;
return doc;
},bindDomNode:function(node){
node=dojo.byId(node);
var cn;
if(node.tagName.toLowerCase()=="iframe"){
var _294=node,win=this._iframeContentWindow(_294);
cn=dojo.withGlobal(win,dojo.body);
}else{
cn=(node==dojo.body()?dojo.doc.documentElement:node);
}
var _295={node:node,iframe:_294};
dojo.attr(node,"_dijitMenu"+this.id,this._bindings.push(_295));
var _296=dojo.hitch(this,function(cn){
return [dojo.connect(cn,this.leftClickToOpen?"onclick":"oncontextmenu",this,function(evt){
dojo.stopEvent(evt);
this._scheduleOpen(evt.target,_294,{x:evt.pageX,y:evt.pageY});
}),dojo.connect(cn,"onkeydown",this,function(evt){
if(evt.shiftKey&&evt.keyCode==dojo.keys.F10){
dojo.stopEvent(evt);
this._scheduleOpen(evt.target,_294);
}
})];
});
_295.connects=cn?_296(cn):[];
if(_294){
_295.onloadHandler=dojo.hitch(this,function(){
var win=this._iframeContentWindow(_294);
cn=dojo.withGlobal(win,dojo.body);
_295.connects=_296(cn);
});
if(_294.addEventListener){
_294.addEventListener("load",_295.onloadHandler,false);
}else{
_294.attachEvent("onload",_295.onloadHandler);
}
}
},unBindDomNode:function(_297){
var node;
try{
node=dojo.byId(_297);
}
...
var _298="_dijitMenu"+this.id;
if(node&&dojo.hasAttr(node,_298)){
var bid=dojo.attr(node,_298)-1,b=this._bindings[bid];
dojo.forEach(b.connects,dojo.disconnect);
var _299=b.iframe;
if(_299){
if(_299.removeEventListener){
_299.removeEventListener("load",b.onloadHandler,false);
}else{
_299.detachEvent("onload",b.onloadHandler);
}
}
dojo.removeAttr(node,_298);
delete this._bindings[bid];
}
},_scheduleOpen:function(_29a,_29b,_29c){
if(!this._openTimer){
this._openTimer=setTimeout(dojo.hitch(this,function(){
delete this._openTimer;
this._openMyself({target:_29a,iframe:_29b,coords:_29c});
}),1);
}
},_openMyself:function(args){
var _29d=args.target,_29e=args.iframe,_29f=args.coords;
if(_29f){
if(_29e){
var od=_29d.ownerDocument,ifc=dojo.position(_29e,true),win=this._iframeContentWindow(_29e),_2a0=dojo.withGlobal(win,"_docScroll",dojo);
var cs=dojo.getComputedStyle(_29e),tp=dojo._toPixelValue,left=(dojo.isIE&&dojo.isQuirks?0:tp(_29e,cs.paddingLeft))+(dojo.isIE&&dojo.isQuirks?tp(_29e,cs.borderLeftWidth):0),top=(dojo.isIE&&dojo.isQuirks?0:tp(_29e,cs.paddingTop))+(dojo.isIE&&dojo.isQuirks?tp(_29e,cs.borderTopWidth):0);
_29f.x+=ifc.x+left-_2a0.x;
_29f.y+=ifc.y+top-_2a0.y;
}
}else{
_29f=dojo.position(_29d,true);
_29f.x+=10;
_29f.y+=10;
}
var self=this;
var _2a1=dijit.getFocus(this);
function _2a2(){
if(self.refocus){
dijit.focus(_2a1);
}
...
dijit.popup.open({popup:this,x:_29f.x,y:_29f.y,onExecute:_2a2,onCancel:_2a2,orient:this.isLeftToRight()?"L":"R"});
this.focus();
...
},_getMenuItemForOption:function(_2a3){
if(!_2a3.value&&!_2a3.label){
return new dijit.MenuSeparator();
}else{
var _2a4=dojo.hitch(this,"_setValueAttr",_2a3);
var item=new dijit.MenuItem({option:_2a3,label:_2a3.label||this.emptyLabel,onClick:_2a4,disabled:_2a3.disabled||false});
dijit.setWaiRole(item.focusNode,"listitem");
return item;
}
},_addOptionItem:function(_2a5){
if(this.dropDown){
this.dropDown.addChild(this._getMenuItemForOption(_2a5));
}
},_getChildren:function(){
if(!this.dropDown){
return [];
...
dojo.forEach(this._getChildren(),function(_2a7){
...
},_setDisplay:function(_2a9){
var lbl=_2a9||this.emptyLabel;
...
},validate:function(_2aa){
var _2ab=this.isValid(_2aa);
this._set("state",_2ab?"":"Error");
dijit.setWaiState(this.focusNode,"invalid",_2ab?"false":"true");
var _2ac=_2ab?"":this._missingMsg;
if(this.message!==_2ac){
this._set("message",_2ac);
dijit.hideTooltip(this.domNode);
if(_2ac){
dijit.showTooltip(_2ac,this.domNode,this.tooltipPosition,!this.isLeftToRight());
}
}
return _2ab;
},isValid:function(_2ad){
...
},uninitialize:function(_2b0){
if(this.dropDown&&!this.dropDown._destroyed){
this.dropDown.destroyRecursive(_2b0);
...
var _2b2=dojo.mixin(dojo.i18n.getLocalization("dijit","common",this.lang),dojo.i18n.getLocalization("dijit._editor","LinkDialog",this.lang));
var _2b3=(this.dropDown=new dijit.TooltipDialog({title:_2b2[this.command+"Title"],execute:dojo.hitch(this,"setValue"),onOpen:function(){
_2b1._onOpenDialog();
dijit.TooltipDialog.prototype.onOpen.apply(this,arguments);
},onCancel:function(){
setTimeout(dojo.hitch(_2b1,"_onCloseDialog"),0);
}}));
_2b2.urlRegExp=this.urlRegExp;
_2b2.id=dijit.getUniqueId(this.editor.id);
this._uniqueId=_2b2.id;
this._setContent(_2b3.title+"<div style='border-bottom: 1px black solid;padding-bottom:2pt;margin-bottom:4pt'></div>"+dojo.string.substitute(this.linkDialogTemplate,_2b2));
_2b3.startup();
...
var _2b4=this._urlInput.get("value");
return this._urlRegExp.test(_2b4)||this._emailRegExp.test(_2b4);
});
...
},_setContent:function(_2b8){
this.dropDown.set({parserScope:"dojo",content:_2b8});
...
if(dojo.isIE<9){
var sel=dijit.range.getSelection(this.editor.window);
var _2b9=sel.getRangeAt(0);
var a=_2b9.endContainer;
if(a.nodeType===3){
a=a.parentNode;
}
...
_2ba=a.getAttribute("target")||"_self";
text=a.textContent||a.innerText;
dojo.withGlobal(this.editor.window,"selectElement",dijit._editor.selection,[a,true]);
}else{
text=dojo.withGlobal(this.editor.window,dijit._editor.selection.getSelectedText);
}
return {urlInput:url||"",textInput:text||"",targetSelect:_2ba||""};
},_onOpenDialog:function(){
var a;
if(dojo.isIE<9){
var sel=dijit.range.getSelection(this.editor.window);
var _2bb=sel.getRangeAt(0);
a=_2bb.endContainer;
if(a.nodeType===3){
a=a.parentNode;
}
...
o.plugin=new dijit._editor._Plugin({button:new dojox.editor.plugins.ToolbarLineBreak(),setEditor:function(_2bc){
this.editor=_2bc;
}});
}
});
...
this.value=_2bd;
this.textBox.set("value",_2bd);
},focus:function(){
this.textBox.focus();
},_setDisabledAttr:function(_2be){
this.disabled=_2be;
this.textBox.set("disabled",_2be);
...
_2bf=evt.target.selectionStart;
end=evt.target.selectionEnd;
if(_2bf<end){
dijit.selectInputText(evt.target,_2bf,_2bf);
dojo.stopEvent(evt);
}
}else{
...
},_setValueAttr:function(_2c0){
this.checkBox.set("value",_2c0);
},_getValueAttr:function(){
...
this.disabled=_2c1;
this.checkBox.set("disabled",_2c1);
}});
...
},setEditor:function(_2c4){
this.editor=_2c4;
this._initButton();
},toggle:function(){
this.button.set("checked",!this.button.get("checked"));
},_toggleFindReplace:function(show,_2c5,_2c6){
...
var ed=this.editor;
var win=ed.window;
var _2c7=dojo.withGlobal(ed.window,"getSelectedText",dijit._editor.selection,[null]);
if(this._findField&&this._findField.textBox){
if(_2c7){
this._findField.textBox.set("value",_2c7);
}
this._findField.textBox.focus();
dijit.selectInputText(this._findField.textBox.focusNode);
}
},setToolbar:function(_2c8){
this.inherited(arguments);
if(!dojo.isOpera){
var _2c9=this._frToolbar=new dojox.editor.plugins._FindReplaceToolbar();
dojo.style(_2c9.domNode,"display","none");
dojo.place(_2c9.domNode,_2c8.domNode,"after");
_2c9.startup();
this._closeBox=new dojox.editor.plugins._FindReplaceCloseBox();
_2c9.addChild(this._closeBox);
...
_2c9.addChild(this._replaceField);
_2c9.addChild(new dojox.editor.plugins.ToolbarLineBreak());
...
_2c9.addChild(this._findButton);
...
_2c9.addChild(this._replaceButton);
...
_2c9.addChild(this._replaceAllButton);
...
_2c9.addChild(this._caseSensitive);
...
var _2ca=this._findField.get("value");
if(_2ca){
...
if(txt){
var _2cc=this._caseSensitive.get("value");
var _2cd=this._backwards.get("value");
var _2ce=this._findText(txt,_2cc,_2cd);
if(!_2ce&&_2cb){
...
return false;
},_replace:function(_2cf){
var _2d0=false;
var ed=this.editor;
ed.focus();
var txt=this._findField.get("value")||"";
var _2d1=this._replaceField.get("value")||"";
if(txt){
var _2d2=this._caseSensitive.get("value");
var _2d3=this._backwards.get("value");
var _2d4=dojo.withGlobal(ed.window,"getSelectedText",dijit._editor.selection,[null]);
if(dojo.isMoz){
txt=dojo.trim(txt);
_2d4=dojo.trim(_2d4);
}
var _2d5=this._filterRegexp(txt,!_2d2);
if(_2d4&&_2d5.test(_2d4)){
ed.execCommand("inserthtml",_2d1);
_2d0=true;
if(_2d3){
this._findText(_2d1,_2d2,_2d3);
dojo.withGlobal(ed.window,"collapse",dijit._editor.selection,[true]);
}
}
if(!this._find(false)&&_2cf){
...
return null;
},_replaceAll:function(_2d6){
var _2d7=0;
var _2d8=this._backwards.get("value");
if(_2d8){
...
var _2d9=dojo.hitch(this,function(){
if(this._replace(false)){
_2d7++;
setTimeout(_2d9,10);
}else{
if(_2d6){
this._promDialog.set("content",dojo.string.substitute(this._strings["replaceDialogText"],{"0":""+_2d7}));
...
_2d9();
},_findText:function(txt,_2da,_2db){
var ed=this.editor;
var win=ed.window;
var _2dc=false;
if(txt){
if(win.find){
_2dc=win.find(txt,_2da,_2db,false,false,false,false);
}else{
var doc=ed.document;
if(doc.selection){
this.editor.focus();
var _2dd=doc.body.createTextRange();
var _2de=doc.selection?doc.selection.createRange():null;
if(_2de){
if(_2db){
_2dd.setEndPoint("EndToStart",_2de);
}else{
_2dd.setEndPoint("StartToEnd",_2de);
}
}
var _2df=_2da?4:0;
if(_2db){
...
_2dc=_2dd.findText(txt,_2dd.text.length,_2df);
if(_2dc){
_2dd.select();
}
}
...
return _2dc;
},_filterRegexp:function(_2e0,_2e1){
var rxp="";
var c=null;
...
},setReadonly:function(_2e2){
if(this.readonly&&!_2e2){
var val=this.getDataValue();
this.inherited(arguments,[_2e2,true]);
...
var _2e3=this.editorNode.childNodes[0].clientHeight;
if(h<=_2e3){
h=Math.max(40,this.bounds.h-20);
_2e3=20;
}
this.editor.iframe.style.height=(h-_2e3)+"px";
if(this.editor.focusNode){
this.editor.focusNode.style.height=(h-_2e3)+"px";
}
dojo.query(".dijitComboBox input, .dijitToolbar",this.domNode).forEach(function(node){
node.style.lineHeight="normal";
node.style.height="";
});
},_createEditor:function(_2e4,_2e5){
if(!this.readonly){
this._ready=false;
...
var _2e6=new dijit.form.SimpleTextarea(this.getEditorProps(_2e4,_2e5));
_2e6.domNode.style.lineHeight="normal";
return _2e6;
}
},_onLoad:function(){
this._ready=true;
...
var _2e7=dojo.query(".dijitToolbar",this.domNode)[0];
_2e7.style.lineHeight="24px";
});
}
},isReady:function(){
return Boolean(this._ready&&this.editor&&this.editor.focusNode);
},setDisabled:function(_2e8){
this.disabled=_2e8;
if(this.editor){
...
try{
var _2e9=this.inherited(arguments);
if(_2e9.match(/^\s*\<.*\>\s*$/)&&!_2e9.match(/\>\w/)){
_2e9="";
}
return _2e9;
}
...
return this.dataValue;
},_setEditorAttempts:0,setEditorValue:function(_2ea){
this.dataValue=_2ea;
if(!this.editor||this.editor instanceof dijit.form.SimpleTextarea){
this.updateReadonlyValue(_2ea);
return;
}
if(this.editor&&!this.editor.isLoaded){
this.editor.onLoadDeferred.addCallback(dojo.hitch(this,"setEditorValue",_2ea));
return;
}
...
wm.Object.extendSchema(wm.RichText,{toolbarUndo:{group:"editor",subgroup:"toolbar",order:1,shortname:"undo"},toolbarStyle:{group:"editor",subgroup:"toolbar",order:2,shortname:"styles"},toolbarStyleAll:{group:"editor",subgroup:"toolbar",order:3,shortname:"more styles"},toolbarAlign:{group:"editor",subgroup:"toolbar",order:4,shortname:"align"},toolbarList:{group:"editor",subgroup:"toolbar",order:5,shortname:"lists"},toolbarLink:{group:"editor",subgroup:"toolbar",order:6,shortname:"link"},toolbarFontName:{group:"editor",subgroup:"toolbar",order:7,shortname:"fontName"},toolbarFormatName:{group:"editor",subgroup:"toolbar",order:8,shortname:"formatName"},toolbarSize:{group:"editor",subgroup:"toolbar",order:9,shortname:"size"},toolbarColor:{group:"editor",subgroup:"toolbar",order:11,shortname:"color"},toolbarFind:{group:"editor",subgroup:"toolbar",order:12,shortname:"find & replace"},selectOnClick:{ignore:1},changeOnEnter:{ignore:1},changeOnKey:{ignore:1},password:{ignore:1},emptyValue:{ignore:1},regExp:{ignore:1},invalidMessage:{ignore:1},maxChars:{ignore:1},singleLine:{ignore:1},tooltipDisplayTime:{ignore:1},promptMessage:{ignore:1},displayValue:{ignore:1},setToolbarUndo:{method:1},setToolbarStyle:{method:1},setToolbarStyleAll:{method:1},setToolbarAlign:{method:1},setToolbarList:{method:1},setToolbarLink:{method:1},setToolbarFont:{method:1},setToolbarFormat:{method:1},setToolbarSize:{method:1},setToolbarColor:{method:1}});
